 ...
 *
 * `label` is the short heading used on the summary sheet (and can head the card
 * face). It never replaces `front`/`back` - it's just a scannable term.
 */
export const s3 = {
  id: "s3",
  title: "S3",
  ...
  cards: [
    ...
    {
      id: "s3-object-size",
      label: "Max object size & multipart",
      type: "definition",
      front:
    ...
    },
    {
      ...
      label: "Unknown / changing access patterns",
      type: "scenario",
      front:
    ...
    {
      id: "s3-one-zone-ia",
      label: "Infrequent, easily recreatable data",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "Archive, millisecond retrieval",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "Glacier Flexible retrieval tiers",
      type: "definition",
    ...
    },
    {
      ...
      label: "Cheapest long-term archive",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "Share data, shift the download cost",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "Replication requirements",
      type: "definition",
    ...
    },
    {
      ...
      label: "Slow uploads from far-away users",
      type: "scenario",
    ...
    {
      id: "s3-presigned-url",
      label: "One-object access, no credentials",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "Object Lock: Governance vs Compliance",
      type: "comparison",
    ...
    {
      id: "s3-access-points",
      label: "Per-app bucket access, one VPC-only",
      type: "scenario",
      front:
    ...
    {
      id: "s3-object-lambda",
      label: "Transform objects on read",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "Event notification targets",
      type: "definition",
    ...
    },
    {
      ...
      label: "Partner file transfer (SFTP/FTPS/FTP)",
      type: "scenario",
      front:
    ...
    {
      id: "s3-datasync",
      label: "Move bulk data on-prem → AWS",
      type: "scenario",
      front:
    ...
    },
    {
      ...
      label: "FSx for Windows vs FSx for Lustre",
      type: "comparison",
    ...
    },
    {
      ...
      label: "FSx Lustre: Scratch vs Persistent",
      type: "comparison",
