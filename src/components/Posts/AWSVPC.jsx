...
const AWSVPC = () => {
  ...
  const natData = [
    {
      "": "Availability",
      "NAT Gateway":
        "Highly available within AZ (create another in a different AZ)",
  ...
  const sgNaclData = [
    ...
    },
    {
      ...
      NACL: "Rules are evaluated in order (lowest to highest) and the first match wins",
    },
    {
      "Security Group":
        "Applies to an EC2 instance when the group is attached to its ENI",
      NACL: "Automatically applies to all ENIs / instances in the subnet that it is associated with",
    },
  ];
  ...
  return (
    <PageWrapper>
      ...
      <PostContainer>
        ...
        <TextList>
          <TextListItem>
            <TextLink href="#vpc-introduction">
          ...
          <TextListItem>
            <TextLink href="#networking-costs">
        ...
        <Paragraph>
          ...
          AWS Cloud where you can launch AWS resources (such as EC2 instances)
          within a virtual network that you define. A VPC lets you customise
          your network environment: choose your own IP address ranges, create
          subnets, configure route tables and gateways, and tightly control
          network access.
        </Paragraph>
        <PostImage
          src={VPCTransitGatewayOverview}
          alt="VPC and Transit Gateway overview"
        />
        ...
        <Paragraph>
          CIDR is a method used for allocating IP addresses and routing internet
          traffic. It underpins how you carve up address space inside a VPC.
        </Paragraph>

        <SubSectionHeading>IP Addressing</SubSectionHeading>
        <Paragraph>
          An IP address is a numerical label assigned to a device on a network.
          CIDR works with both IPv4 and IPv6, but is most commonly associated
          with IPv4 in VPC design.
        </Paragraph>

        <SubSectionHeading>CIDR Notation</SubSectionHeading>
        <Paragraph>
          CIDR notation consists of an IP address followed by a slash and a
          prefix length describing the network bits, for example:{" "}
          <Strong>192.168.1.0/24</Strong>.
        </Paragraph>
        <TextList>
          <TextListItem>192.168.1.0 - the network address.</TextListItem>
          <TextListItem>
            /24 - the first 24 bits are the network portion, leaving 8 bits for
            hosts.
          </TextListItem>
        </TextList>
        ...
        <Paragraph>
          CIDR allows you to create subnets by varying the prefix length. The
          smaller the prefix (e.g. /16 vs /24), the larger the network.
        </Paragraph>
        <TextList>
        ...
        <TextList>
          <TextListItem>
            <Strong>192.168.1.0/24</Strong> - 256 IPs
        ...
        <Paragraph>
          The Internet Assigned Numbers Authority (IANA) defined specific
        ...
        <Paragraph>
          All other non-reserved addresses are generally routable on the public
          internet.
        </Paragraph>
        ...
        <TextList>
          <TextListItem>
            You can have multiple VPCs per region (default soft limit is 5).
          </TextListItem>
          <TextListItem>
            Each VPC can have up to 5 IPv4 CIDR blocks (plus IPv6 CIDRs).
          </TextListItem>
          <TextListItem>
            Per CIDR block: minimum size /28 (16 IPs), maximum size /16 (65,536
            IPs).
          </TextListItem>
          <TextListItem>
        ...
        <Paragraph>
          You divide your VPC into subnets, which are slices of your VPC CIDR
          tied to specific Availability Zones. Subnets can be public (routable
          to the internet through an IGW) or private (no direct internet route).
        </Paragraph>
        ...
        <TextList>
          ...
          <TextListItem>
            .255 - Network broadcast address (not used in VPC, but still
            reserved)
          </TextListItem>
        </TextList>
        <Paragraph>
          When sizing subnets, remember these reserved IPs. For example, if you
          need 29 EC2 instances:
        </Paragraph>
        <TextList>
          <TextListItem>
        ...
        <Paragraph>
          To provide internet access for resources in your VPC, you attach an
          Internet Gateway. Routes in your route tables then send 0.0.0.0/0 (or
          specific prefixes) towards the IGW.
        </Paragraph>
        <TextList>
          <TextListItem>
            Allows resources in public subnets to connect to and be reached from
            the internet.
          </TextListItem>
          <TextListItem>
            Created separately and then attached to a VPC.
          </TextListItem>
          <TextListItem>One IGW attaches to exactly one VPC.</TextListItem>
          <TextListItem>
            On its own, it does nothing - you must update route tables.
          </TextListItem>
        </TextList>
        <PostImage
          src={VPCInternetGateway}
          alt="VPC Internet Gateway example"
        />

        <SectionHeading id="vpc-bastion-hosts">Bastion Hosts</SectionHeading>
        <Paragraph>
          A bastion host is a hardened entry point into your private network,
          typically used to SSH into private EC2 instances.
        </Paragraph>
        <TextList>
          <TextListItem>
            Bastion host lives in a public subnet with inbound SSH (port 22)
            allowed from a restricted IP/CIDR.
          </TextListItem>
          <TextListItem>
            Private instances allow SSH from the bastion's security group or
            private IP.
          </TextListItem>
          <TextListItem>
        ...
        <Paragraph>
          A NAT Gateway lets instances in private subnets initiate outbound
          connections to the internet, while remaining unreachable from the
          internet.
        </Paragraph>
        <TextList>
          ...
          <TextListItem>
            No security groups; you control access via NACLs + routes.
          </TextListItem>
        </TextList>
        ...
        <Paragraph>
          For high availability, deploy a NAT Gateway per AZ and configure
          private subnets to use the NAT Gateway in their own AZ.
        </Paragraph>
        <PostImage
          src={VPCNATGateWayHA}
          alt="NAT Gateway high-availability pattern"
        />

        <SubSectionHeading>NAT Gateway vs NAT Instance</SubSectionHeading>
        <Table columns={natColumns} data={natData} />

        <SectionHeading id="sg-nacls">
          Security Groups &amp; NACLs
        </SectionHeading>
        <Paragraph>
          Security groups and Network ACLs both control traffic, but at
          different layers and with different behaviour.
        </Paragraph>

        <SubSectionHeading>What is a NACL?</SubSectionHeading>
        <Paragraph>
          A Network ACL is a stateless firewall operating at the subnet level.
          Each subnet must be associated with a NACL (or the default NACL).
        </Paragraph>
        <TextList>
          <TextListItem>
            Controls inbound and outbound traffic at subnet level.
          </TextListItem>
          <TextListItem>
        ...
        <TextList>
          <TextListItem>
            <Strong>NACLs are stateless</Strong> - return traffic must be
            explicitly allowed.
          </TextListItem>
          <TextListItem>
            <Strong>Security groups are stateful</Strong> - return traffic is
        ...
        <Paragraph>
          Ephemeral ports are short-lived client-side ports used when initiating
          outbound connections. Different OSes use different ranges:
        </Paragraph>
        <TextList>
        ...
        <Paragraph>
          When defining NACL rules, you must explicitly allow these ephemeral
          port ranges for return traffic.
        </Paragraph>
        <PostImage
        ...
        <Paragraph>
          VPC Peering connects two VPCs so they can communicate using private
          IPs, as if they were part of the same network.
        </Paragraph>
        <TextList>
          <TextListItem>
            Supports same-account and cross-account peering.
          </TextListItem>
          <TextListItem>
            Supports same-region and cross-region peering.
          </TextListItem>
          <TextListItem>
        ...
        <Paragraph>
          VPC Endpoints enable private connectivity from your VPC to supported
          AWS services and endpoint services without needing an IGW, NAT device,
          VPN, or Direct Connect. Traffic stays on the AWS network.
        </Paragraph>
        ...
        <TextList>
          <TextListItem>
            Create an Elastic Network Interface (ENI) with a private IP in your
            subnet.
          </TextListItem>
          <TextListItem>
            Used to access many AWS services and custom endpoint services via
            PrivateLink.
          </TextListItem>
          <TextListItem>
        ...
        <TextList>
          ...
          <TextListItem>
            Add a route in your route tables pointing service traffic to the
            endpoint.
          </TextListItem>
          <TextListItem>
        ...
        <PostImage
          src={VPCGatewayEndpoint}
          alt="Gateway endpoint to S3 example"
        />

        <SectionHeading id="vpc-flow-logs">VPC Flow Logs</SectionHeading>
        <Paragraph>
          VPC Flow Logs capture IP traffic going to and from ENIs in your VPC.
          Logs can be delivered to CloudWatch Logs, S3, or Kinesis Data Firehose
          for analysis.
        </Paragraph>
        <PostImage src={VPCFlowLogSyntax} alt="VPC flow log record syntax" />
        <PostImage
          src={VPCFlowLogs}
          alt="VPC flow logs high-level architecture"
        />

        <SectionHeading id="site-to-site-vpn">Site-to-Site VPN</SectionHeading>
        <Paragraph>
          A Site-to-Site VPN provides an encrypted IPSec tunnel between your
          on-premises network and your VPC over the public internet.
        </Paragraph>
        ...
        <TextList>
          <TextListItem>
            <Strong>Virtual Private Gateway (VGW)</Strong> - AWS side VPN
            concentrator, attached to your VPC. You can customise its ASN.
          </TextListItem>
          <TextListItem>
            <Strong>Customer Gateway (CGW)</Strong> - your on-premises VPN
            device or software appliance.
          </TextListItem>
        </TextList>

        <SubSectionHeading>Site-to-Site VPN Connections</SubSectionHeading>
        <Paragraph>
          If your CGW has a private IP, you typically use the NAT device's
          public IP for the tunnel; otherwise you use the CGW's public IP
          directly. Make sure you enable route propagation to the VGW in your
          route tables and open ICMP / any required ports in security groups.
        </Paragraph>
        <PostImage
        ...
        <Paragraph>
          AWS VPN CloudHub allows you to connect multiple remote sites (branch
          offices) via a hub-and-spoke model using the same VGW. It's useful
          when sites need to talk to each other and to AWS.
        </Paragraph>
        <PostImage
        ...
        />
        <Paragraph>
          You configure multiple VPN connections on the same VGW, enable dynamic
          routing, and update route tables accordingly.
        </Paragraph>
        ...
        <Paragraph>
          ...
          from your on-premises environment to AWS, bypassing the public
          internet for more predictable performance.
        </Paragraph>
        <PostImage
          src={VPCDirectConnect}
          alt="Direct Connect basic architecture"
        />
        <Paragraph>
          To connect to one or more VPCs in different regions within the same
          account, you use a <Strong>Direct Connect Gateway</Strong>.
        </Paragraph>
        <PostImage
        ...
        <IndentedTextList>
          <IndentedTextListItem>
            Provisioned by a Direct Connect Partner.
          </IndentedTextListItem>
          <IndentedTextListItem>
        ...
        <Paragraph>
          Direct Connect itself is private but not encrypted. For encryption,
          you can run a Site-to-Site VPN over Direct Connect.
        </Paragraph>
        <PostImage
        ...
        <Paragraph>
          For critical workloads, design redundant DX connections (and
          potentially VPN backup) across multiple locations.
        </Paragraph>
        <PostImage
        ...
        <Paragraph>
          Instead of paying for a second DX connection, you can use a
          Site-to-Site VPN as a failover path if the DX link goes down.
        </Paragraph>
        <PostImage
        ...
        <Paragraph>
          AWS Transit Gateway (TGW) provides a central hub to connect VPCs,
          on-premises networks and VPN/DX attachments at scale. It supports
          multicast (which VPC peering and other constructs do not).
        </Paragraph>
        <PostImage src={VPCTransitGateway} alt="Transit Gateway basic view" />

        <SubSectionHeading>Site-to-Site VPN ECMP</SubSectionHeading>
        <Paragraph>
          ECMP (Equal Cost Multi-Path) with TGW allows you to use multiple VPN
          tunnels in parallel to increase effective bandwidth.
        </Paragraph>
        <PostImage
        ...
        <SubSectionHeading>
          Direct Connect Across Multiple Accounts
        </SubSectionHeading>
        <PostImage
        ...
        <SectionHeading id="traffic-mirroring">
          Traffic Mirroring
        </SectionHeading>
        <Paragraph>
          VPC Traffic Mirroring lets you capture and inspect network traffic
          from ENIs of your EC2 instances. You can send mirrored traffic to
          security appliances or monitoring tools for deep inspection.
        </Paragraph>
        <PostImage
        ...
        <Paragraph>
          IPv6 is the successor to IPv4 and provides a vastly larger address
          space. In VPCs, IPv6 addresses are globally unique and effectively
          public, but security controls still apply via SGs and NACLs.
        </Paragraph>
        <Paragraph>
          You can enable dual-stack mode (IPv4 + IPv6). Instances then receive
          at least a private IPv4 and a public IPv6 address. IPv4 cannot
          currently be disabled in a VPC.
        </Paragraph>
        <PostImage src={VPCIPv6} alt="IPv6 addressing in VPC" />

        <SubSectionHeading>Egress-Only Internet Gateway</SubSectionHeading>
        <Paragraph>
          An Egress-Only Internet Gateway provides outbound-only internet access
          for IPv6 traffic from your VPC. It is conceptually similar to a NAT
          Gateway but only for IPv6.
        </Paragraph>
        <PostImage
          src={VPCEgressOnlyIG}
        ...
        <SectionHeading id="networking-costs">
          Networking Costs in AWS
        </SectionHeading>
        <SubSectionHeading>
        ...
        <Paragraph>
          In general, you save money and gain performance by keeping traffic
          inside AWS and inside the same AZ where possible.
        </Paragraph>
        <TextList>
          <TextListItem>
          ...
          <TextListItem>
            Same-AZ traffic is cheaper than cross-AZ; cross-region and internet
            egress are the most expensive.
          </TextListItem>
        </TextList>
        <PostImage
        ...
        <SubSectionHeading>
          Minimising Egress Traffic Network Costs
        </SubSectionHeading>
        <TextList>
          <TextListItem>
          ...
          <TextListItem>
            <Strong>Ingress:</Strong> inbound traffic (outside to AWS, typically
            free).
          </TextListItem>
        </TextList>
        <Paragraph>
          Keep as much traffic as possible within AWS. When using Direct
          Connect, locate your DX connection in the same region as your VPCs
          where possible to reduce charges.
        </Paragraph>
        <PostImage
        ...
        <SectionHeading id="network-protection">
          AWS Network Firewall
        </SectionHeading>
        <Paragraph>
          AWS Network Firewall is a managed network security service for your
          VPC. It provides stateful inspection, intrusion prevention and
          detection, and web filtering.
        </Paragraph>
        ...
        <TextList>
          <TextListItem>
            <Strong>Traffic Filtering:</Strong> allow, block, or monitor traffic
            based on IPs, ports, protocols and domains.
          </TextListItem>
          <TextListItem>
            <Strong>Managed Rules:</Strong> use curated rule groups from AWS and
            partners, updated to address new threats.
          </TextListItem>
          <TextListItem>
            <Strong>Custom Rules:</Strong> define your own stateless and
            stateful rule groups.
          </TextListItem>
          <TextListItem>
            <Strong>Stateful &amp; Stateless:</Strong> combine stateless
            inspection with deeper stateful analysis.
          </TextListItem>
          <TextListItem>
            <Strong>Logging &amp; Monitoring:</Strong> send detailed logs to S3,
            CloudWatch Logs, or Kinesis Data Firehose.
          </TextListItem>
          <TextListItem>
            <Strong>Centralised Management:</Strong> integrate with AWS Firewall
            Manager to apply policies across multiple accounts and VPCs.
          </TextListItem>
        </TextList>
        ...
        <TextList>
          ...
          <TextListItem>
            <Strong>VPC:</Strong> container for your subnets, route tables,
          ...
          <TextListItem>
            <Strong>Internet Gateway:</Strong> internet access for IPv4 &amp;
            IPv6.
          </TextListItem>
          <TextListItem>
            <Strong>Route Tables:</Strong> direct traffic to IGWs, NAT GWs,
            peering links, endpoints, TGWs, etc.
          </TextListItem>
          <TextListItem>
            <Strong>Bastion Host:</Strong> public SSH entry point to private
            instances.
          </TextListItem>
          <TextListItem>
            <Strong>NAT Instance/Gateway:</Strong> outbound-only internet access
            for private IPv4 instances.
          </TextListItem>
          <TextListItem>
          ...
          <TextListItem>
            <Strong>VPC Peering:</Strong> non-transitive private connectivity
            between VPCs.
          </TextListItem>
          <TextListItem>
            <Strong>VPC Endpoints:</Strong> private access to AWS services over
            the AWS network.
          </TextListItem>
          <TextListItem>
            <Strong>VPC Flow Logs:</Strong> capture ACCEPT/REJECT traffic for
            analysis.
          </TextListItem>
          <TextListItem>
            <Strong>Site-to-Site VPN / CloudHub:</Strong> IPsec connectivity for
            on-prem and multi-site topologies.
          </TextListItem>
          <TextListItem>
          ...
          <TextListItem>
            <Strong>PrivateLink:</Strong> private service endpoints without
            peering or internet.
          </TextListItem>
          <TextListItem>
            <Strong>Transit Gateway:</Strong> hub-and-spoke routing for VPCs,
            VPN, and DX.
          </TextListItem>
          <TextListItem>
          ...
          <TextListItem>
            <Strong>Egress-Only IGW:</Strong> outbound-only internet access for
            IPv6.
          </TextListItem>
        </TextList>
